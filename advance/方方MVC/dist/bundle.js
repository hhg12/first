...
var handerbars = __webpack_require__(31);
...
var Controller = function () {
  ...
  _createClass(Controller, [{
    ...
    value: function render() {
      var template = this.template[0] === '#' ? (0, _jquery2.default)(this.template).html() : this.template;
      var html = handerbars.compile(template)(this.model.data);
...
var handlebars = __webpack_require__(32)['default'];

var printer = __webpack_require__(40);
...
var _handlebarsCompilerCompiler = __webpack_require__(37);

var _handlebarsCompilerJavascriptCompiler = __webpack_require__(38);
...
var _codeGen = __webpack_require__(39);
...
var model = {
  ...
  get: function get() {
    ...
    return _jquery2.default.get("./data.json").then(function (response) {
      //     装一下从服务器获得数据
      _this.data = response;
    });
  },
...
new _Controller2.default({
  ...
  increase: function increase() {
    ...
    this.model.increase().then(function () {
      _this5.render();
    });
  },
  decrease: function decrease() {
    ...
    this.model.decrease().then(function () {
      _this6.render();
    });
  }
});
